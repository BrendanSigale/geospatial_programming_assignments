...
def modechecker():
    modecheck = input("Enter a type (min, max, or avg): ")
    if modecheck != 'min' and modecheck != 'max' and modecheck != 'avg':
...
mode = modechecker()
count = int(input("Choose a number of input values: "))
